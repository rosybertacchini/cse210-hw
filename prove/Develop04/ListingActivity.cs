...
// attributes
    ...
    // setters and getters
       ...
       private void AddIndexPromptQuestionUsedInTheSession(int indexPrompt) {
        ...
        private Boolean  IsThisPromptQuestionIndexUsed(int indexPrompt ){
    ...
    //methods
        ...
        public void  RunActivity(){
                ...
                string thePromptQuestion = GetPromptQuestion();
                int indexPromptQuestion = _promptQuestions.IndexOf(thePromptQuestion);    
                ...
                if (allPromtQuestionsHasBeenUsed()) {
                                ...
                                Console.WriteLine("\t\t\t ***** PromptQuestions will be re-used...");
                                AddIndexPromptQuestionUsedInTheSession(indexPromptQuestion);
                }
                else{

                        while (IsThisPromptQuestionIndexUsed(indexPromptQuestion) ) {
                                thePromptQuestion = GetPromptQuestion();
                                indexPromptQuestion = _promptQuestions.IndexOf(thePromptQuestion); 
                        }
                        AddIndexPromptQuestionUsedInTheSession(indexPromptQuestion); 
                }

                Console.WriteLine($"\t\t ->  {thePromptQuestion}");
                Console.WriteLine("");
                // 
                // ***************************************************************************
